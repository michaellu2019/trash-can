// ======================================================================
// trash_can.v generated from TopDesign.cysch
// 12/16/2023 at 02:14
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Right_Drive_DC_Motor_PWM, CY_INSTANCE_SHORT_NAME=Right_Drive_DC_Motor_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Right_Drive_DC_Motor_PWM, )
module PWM_v3_30_6 (
    pwm2,
    tc,
    clock,
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=2, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=499999, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=1, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RC_Ch5_Timer, CY_INSTANCE_SHORT_NAME=RC_Ch5_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=RC_Ch5_Timer, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=3000, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=40000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Head_Servo_PWM, CY_INSTANCE_SHORT_NAME=Head_Servo_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Head_Servo_PWM, )
module PWM_v3_30_8 (
    pwm2,
    tc,
    clock,
...
module top ;
    ...
    PWM_v3_30_4 Left_Drive_DC_Motor_PWM (
        .reset(Net_21),
        .clock(Net_1219),
        .tc(Net_2896),
        .pwm1(Net_2897),
        ...
        .ph1(Net_2905),
        .ph2(Net_2906));
    defparam Left_Drive_DC_Motor_PWM.Resolution = 8;
	...
	wire [0:0] tmpOE__Left_Drive_DC_Motor_Speed_net;
	wire [0:0] tmpFB_0__Left_Drive_DC_Motor_Speed_net;
	wire [0:0] tmpIO_0__Left_Drive_DC_Motor_Speed_net;
	wire [0:0] tmpINTERRUPT_0__Left_Drive_DC_Motor_Speed_net;
	electrical [0:0] tmpSIOVREF__Left_Drive_DC_Motor_Speed_net;
	...
	cy_psoc3_pins_v1_10
		...
		Left_Drive_DC_Motor_Speed
		 (.oe(tmpOE__Left_Drive_DC_Motor_Speed_net),
		  .y({Net_140}),
		  .fb({tmpFB_0__Left_Drive_DC_Motor_Speed_net[0:0]}),
		  .io({tmpIO_0__Left_Drive_DC_Motor_Speed_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_Drive_DC_Motor_Speed_net),
		  .interrupt({tmpINTERRUPT_0__Left_Drive_DC_Motor_Speed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_Drive_DC_Motor_Speed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Left_Drive_DC_Motor_Direction_net;
	wire [0:0] tmpFB_0__Left_Drive_DC_Motor_Direction_net;
	wire [0:0] tmpIO_0__Left_Drive_DC_Motor_Direction_net;
	wire [0:0] tmpINTERRUPT_0__Left_Drive_DC_Motor_Direction_net;
	electrical [0:0] tmpSIOVREF__Left_Drive_DC_Motor_Direction_net;
	...
	cy_psoc3_pins_v1_10
		...
		Left_Drive_DC_Motor_Direction
		 (.oe(tmpOE__Left_Drive_DC_Motor_Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Left_Drive_DC_Motor_Direction_net[0:0]}),
		  .io({tmpIO_0__Left_Drive_DC_Motor_Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_Drive_DC_Motor_Direction_net),
		  .interrupt({tmpINTERRUPT_0__Left_Drive_DC_Motor_Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_Drive_DC_Motor_Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    USBFS_v3_0_5 USBUART (
        .sof(Net_887),
        .vbusdet(1'b0));
    defparam USBUART.epDMAautoOptimization = 0;

    PWM_v3_30_6 Right_Drive_DC_Motor_PWM (
        .reset(Net_929),
        .clock(Net_1219),
        .tc(Net_2907),
        .pwm1(Net_2908),
        ...
        .ph1(Net_2916),
        .ph2(Net_2917));
    defparam Right_Drive_DC_Motor_PWM.Resolution = 8;

    assign Net_929 = 1'h0;

	wire [0:0] tmpOE__Right_Drive_DC_Motor_Speed_net;
	wire [0:0] tmpFB_0__Right_Drive_DC_Motor_Speed_net;
	wire [0:0] tmpIO_0__Right_Drive_DC_Motor_Speed_net;
	wire [0:0] tmpINTERRUPT_0__Right_Drive_DC_Motor_Speed_net;
	electrical [0:0] tmpSIOVREF__Right_Drive_DC_Motor_Speed_net;
	...
	cy_psoc3_pins_v1_10
		...
		Right_Drive_DC_Motor_Speed
		 (.oe(tmpOE__Right_Drive_DC_Motor_Speed_net),
		  .y({Net_978}),
		  .fb({tmpFB_0__Right_Drive_DC_Motor_Speed_net[0:0]}),
		  .io({tmpIO_0__Right_Drive_DC_Motor_Speed_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Drive_DC_Motor_Speed_net),
		  .interrupt({tmpINTERRUPT_0__Right_Drive_DC_Motor_Speed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Drive_DC_Motor_Speed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_Drive_DC_Motor_Direction_net;
	wire [0:0] tmpFB_0__Right_Drive_DC_Motor_Direction_net;
	wire [0:0] tmpIO_0__Right_Drive_DC_Motor_Direction_net;
	wire [0:0] tmpINTERRUPT_0__Right_Drive_DC_Motor_Direction_net;
	electrical [0:0] tmpSIOVREF__Right_Drive_DC_Motor_Direction_net;
	...
	cy_psoc3_pins_v1_10
		...
		Right_Drive_DC_Motor_Direction
		 (.oe(tmpOE__Right_Drive_DC_Motor_Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Right_Drive_DC_Motor_Direction_net[0:0]}),
		  .io({tmpIO_0__Right_Drive_DC_Motor_Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Drive_DC_Motor_Direction_net),
		  .interrupt({tmpINTERRUPT_0__Right_Drive_DC_Motor_Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Drive_DC_Motor_Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Center_Lift_DC_Motor_Direction_1_net;
	wire [0:0] tmpFB_0__Center_Lift_DC_Motor_Direction_1_net;
	wire [0:0] tmpIO_0__Center_Lift_DC_Motor_Direction_1_net;
	wire [0:0] tmpINTERRUPT_0__Center_Lift_DC_Motor_Direction_1_net;
	electrical [0:0] tmpSIOVREF__Center_Lift_DC_Motor_Direction_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Center_Lift_DC_Motor_Direction_1
		 (.oe(tmpOE__Center_Lift_DC_Motor_Direction_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Center_Lift_DC_Motor_Direction_1_net[0:0]}),
		  .io({tmpIO_0__Center_Lift_DC_Motor_Direction_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Center_Lift_DC_Motor_Direction_1_net),
		  .interrupt({tmpINTERRUPT_0__Center_Lift_DC_Motor_Direction_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Center_Lift_DC_Motor_Direction_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Center_Lift_DC_Motor_Direction_2_net;
	wire [0:0] tmpFB_0__Center_Lift_DC_Motor_Direction_2_net;
	wire [0:0] tmpIO_0__Center_Lift_DC_Motor_Direction_2_net;
	wire [0:0] tmpINTERRUPT_0__Center_Lift_DC_Motor_Direction_2_net;
	electrical [0:0] tmpSIOVREF__Center_Lift_DC_Motor_Direction_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		Center_Lift_DC_Motor_Direction_2
		 (.oe(tmpOE__Center_Lift_DC_Motor_Direction_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Center_Lift_DC_Motor_Direction_2_net[0:0]}),
		  .io({tmpIO_0__Center_Lift_DC_Motor_Direction_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Center_Lift_DC_Motor_Direction_2_net),
		  .interrupt({tmpINTERRUPT_0__Center_Lift_DC_Motor_Direction_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Center_Lift_DC_Motor_Direction_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Shoulder_Cam_DC_Motor_Direction_2_net;
	wire [0:0] tmpFB_0__Shoulder_Cam_DC_Motor_Direction_2_net;
	wire [0:0] tmpIO_0__Shoulder_Cam_DC_Motor_Direction_2_net;
	wire [0:0] tmpINTERRUPT_0__Shoulder_Cam_DC_Motor_Direction_2_net;
	electrical [0:0] tmpSIOVREF__Shoulder_Cam_DC_Motor_Direction_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		Shoulder_Cam_DC_Motor_Direction_2
		 (.oe(tmpOE__Shoulder_Cam_DC_Motor_Direction_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Shoulder_Cam_DC_Motor_Direction_2_net[0:0]}),
		  .io({tmpIO_0__Shoulder_Cam_DC_Motor_Direction_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Shoulder_Cam_DC_Motor_Direction_2_net),
		  .interrupt({tmpINTERRUPT_0__Shoulder_Cam_DC_Motor_Direction_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Shoulder_Cam_DC_Motor_Direction_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Shoulder_Cam_DC_Motor_Direction_1_net;
	wire [0:0] tmpFB_0__Shoulder_Cam_DC_Motor_Direction_1_net;
	wire [0:0] tmpIO_0__Shoulder_Cam_DC_Motor_Direction_1_net;
	wire [0:0] tmpINTERRUPT_0__Shoulder_Cam_DC_Motor_Direction_1_net;
	electrical [0:0] tmpSIOVREF__Shoulder_Cam_DC_Motor_Direction_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Shoulder_Cam_DC_Motor_Direction_1
		 (.oe(tmpOE__Shoulder_Cam_DC_Motor_Direction_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Shoulder_Cam_DC_Motor_Direction_1_net[0:0]}),
		  .io({tmpIO_0__Shoulder_Cam_DC_Motor_Direction_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Shoulder_Cam_DC_Motor_Direction_1_net),
		  .interrupt({tmpINTERRUPT_0__Shoulder_Cam_DC_Motor_Direction_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Shoulder_Cam_DC_Motor_Direction_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_5 (
        .z(Net_1981));

    Timer_v2_70_7 RC_Ch5_Timer (
        .reset(Net_1981),
        .interrupt(Net_1982),
        .enable(1'b1),
        .trigger(Net_1984),
        .capture(Net_1984),
        .capture_out(Net_2344),
        .tc(Net_2345),
        .clock(Net_10));
    defparam RC_Ch5_Timer.CaptureCount = 2;
    defparam RC_Ch5_Timer.CaptureCounterEnabled = 0;
    defparam RC_Ch5_Timer.DeviceFamily = "PSoC5";
    defparam RC_Ch5_Timer.InterruptOnCapture = 1;
    defparam RC_Ch5_Timer.InterruptOnTC = 1;
    defparam RC_Ch5_Timer.Resolution = 24;
    defparam RC_Ch5_Timer.SiliconRevision = "0";

	wire [0:0] tmpOE__RC_Ch5_net;
	wire [0:0] tmpIO_0__RC_Ch5_net;
	wire [0:0] tmpINTERRUPT_0__RC_Ch5_net;
	electrical [0:0] tmpSIOVREF__RC_Ch5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("efb266b3-8d6e-492b-8524-46221b2de8c6"),
		  ...
		  .input_buffer_sel(2'b00))
		RC_Ch5
		 (.oe(tmpOE__RC_Ch5_net),
		  .y({1'b0}),
		  .fb({Net_1984}),
		  .io({tmpIO_0__RC_Ch5_net[0:0]}),
		  .siovref(tmpSIOVREF__RC_Ch5_net),
		  .interrupt({tmpINTERRUPT_0__RC_Ch5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RC_Ch5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_2918 = 1'h0;


	cy_clock_v1_0
		#(.id("bd57762f-5f95-4d3a-b891-fa8cf00e7232"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Head_Servo_net;
	wire [0:0] tmpFB_0__Head_Servo_net;
	wire [0:0] tmpIO_0__Head_Servo_net;
	wire [0:0] tmpINTERRUPT_0__Head_Servo_net;
	electrical [0:0] tmpSIOVREF__Head_Servo_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("88993bb1-8e07-4142-bbb9-de5c48fbcb00"),
		  ...
		  .input_buffer_sel(2'b00))
		Head_Servo
		 (.oe(tmpOE__Head_Servo_net),
		  .y({Net_3319}),
		  .fb({tmpFB_0__Head_Servo_net[0:0]}),
		  .io({tmpIO_0__Head_Servo_net[0:0]}),
		  .siovref(tmpSIOVREF__Head_Servo_net),
		  .interrupt({tmpINTERRUPT_0__Head_Servo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Head_Servo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_8 Head_Servo_PWM (
        .reset(Net_2918),
        .clock(Net_3157),
        .tc(Net_2943),
        .pwm1(Net_2944),
        ...
        .ph1(Net_2952),
        .ph2(Net_2953));
    defparam Head_Servo_PWM.Resolution = 16;
